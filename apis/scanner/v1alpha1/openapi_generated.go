...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/soter/scanner/apis/scanner/v1alpha1.ImageReview": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ImageReview describes a peer ping request/response.",
					Properties: map[string]spec.Schema{
						"kind": {
							SchemaProps: spec.SchemaProps{
		...
		"github.com/soter/scanner/apis/scanner/v1alpha1.Vulnerability": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "Vulnerability represents vulnerability entity returned by Clair",
					Properties: map[string]spec.Schema{
						"Name": {
							SchemaProps: spec.SchemaProps{
								Type:   []string{"string"},
						...
						"featureName": {
							SchemaProps: spec.SchemaProps{
								Description: "FixedIn     []Feature `json:\"FixedIn,omitempty\"`",
								Type:        []string{"string"},
								Format:      "",
							},
						},
