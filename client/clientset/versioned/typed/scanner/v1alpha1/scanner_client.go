...
func NewForConfig(c *rest.Config) (*ScannerV1alpha1Client, error) {
	config := *c
	...
	return &ScannerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ScannerV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *ScannerV1alpha1Client {
...
// New creates a new ScannerV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *ScannerV1alpha1Client {
	return &ScannerV1alpha1Client{c}
}
...
func (c *ScannerV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
